                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                            <li><a href="about.html">About Shop Toys</a></li>
                            <li><a href="#">Our Services</a></li>
                            <li><a href="#">How to shop on Shop Toys</a></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <figure class="footer-payments">
                <img src="<?php echo e(asset('assets/images/payments.png')); ?>" alt="Payment methods" width="272"
                    height="20">
            </figure><!-- End .footer-payments -->
        </div><!-- End .container -->
    </div><!-- End .footer-bottom -->
</footer><!-- End .footer -->
<?php /**PATH C:\xampp\htdocs\Shoptoys\resources\views/clien/layout/footer.blade.php ENDPATH**/ ?>