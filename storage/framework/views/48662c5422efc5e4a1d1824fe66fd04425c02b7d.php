<main class="main">
                ...
                <div class="container intro-content">
                    <div class="row justify-content-end">
                        <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                            ...
                            <h1 class="intro-title" style="color: aliceblue">
                            </h1>
                            <!-- End .intro-title -->
    ...
    <div class="container">
        <h2 class="title text-center mb-4">Toys Hot
...
<?php /**PATH C:\xampp\htdocs\Shoptoys\resources\views/clien/layout/banner.blade.php ENDPATH**/ ?>