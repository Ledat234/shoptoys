...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <br><br>
            <div class="pull-left">
                <a class="btn btn-success" href="<?php echo e(route('product.create')); ?>"> Add New Game</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShopGame\resources\views/product/index.blade.php ENDPATH**/ ?>